        ...
        <section id="quienes-somos">
            <div className="contenedor">
                <div className="contenido-quienes-somos">
                    ...
                    <h2><span>1717</span> DADDY CATS ÚNICOS</h2>

                    <p className="textosection1-p">Daddy Cats es una colección de <span className="textosection1-p--span">NFTs</span> desarrollada en la red de <span className="textosection1-p--span">Solana</span>. Ser
                    ...
                    <div className="botones">
                        <a href="https://magiceden.io/marketplace/daddy_cats" target="_blank" className="btn-ghost primary">
                            Únete a Daddy <i className="fa-solid fa-arrow-right-long"></i>
                        </a>
